...
// const VALID_HOUR_REGEX = /^(0[0-9]|1[0-9]|2[0-3])$/;
// const VALID_12_HOUR_REGEX = /^(0[1-9]|1[0-2])$/;
// const VALID_MINUTE_OR_SECOND_REGEX = /^[0-5][0-9]$/;
...
//   return VALID_HOUR_REGEX.test(value);
// }
...
//   return VALID_12_HOUR_REGEX.test(value);
// }
...
//   return VALID_MINUTE_OR_SECOND_REGEX.test(value);
// }
...
//     if (options && localize && formatLong) locale = { options, localize, formatLong };
