  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg className="overflow-visible fill-gray-800/5 dark:fill-gray-800/20" x="50%" y={-1}>
          <path
      ...
      >
        <div
          className="aspect-1108/632 w-277 bg-linear-to-r from-[#9c80ff] to-[#e546d5] opacity-20"
          style={{
            clipPath:
