  ...
  return (
    ...
    >
      ...
      <Link href={`#${anchor}`} onClick={copyToClipboard}>
        <LinkIcon className="text-muted-foreground hover:text-muted-foreground/80" />
      </Link>
    </div>
  );
};
...
const H1 = (props: TypographyProps) => <BaseHeading {...props} variant="h1" />;
const H2 = (props: TypographyProps) => <BaseHeading {...props} variant="h2" />;
const H3 = (props: TypographyProps) => <BaseHeading {...props} variant="h3" />;
const H4 = (props: TypographyProps) => <BaseHeading {...props} variant="h4" />;
const H5 = (props: TypographyProps) => <BaseHeading {...props} variant="h5" />;
const H6 = (props: TypographyProps) => <BaseHeading {...props} variant="h6" />;
const P = (props: TypographyProps) => <BaseHeading {...props} variant="p" />;
