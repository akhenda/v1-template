...
const turnIntoItems = [
  { icon: <PilcrowIcon />, keywords: ['paragraph'], label: 'Text', value: ParagraphPlugin.key },
  { icon: <Heading1Icon />, keywords: ['title', 'h1'], label: 'Heading 1', value: HEADING_KEYS.h1 },
  {
    icon: <Heading2Icon />,
  ...
  { icon: <FileCodeIcon />, keywords: ['```'], label: 'Code', value: CodeBlockPlugin.key },
  {
    icon: <QuoteIcon />,
...
export function TurnIntoDropdownMenuSimple(props: DropdownMenuProps) {
