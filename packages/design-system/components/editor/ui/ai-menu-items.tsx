...
const menuStateItems: Record<
  EditorChatState,
  { items: (typeof aiChatItems)[keyof typeof aiChatItems][]; heading?: string }[]
> = {
  cursorCommand: [
    {
      items: [
  ...
  cursorSuggestion: [{ items: [aiChatItems.accept, aiChatItems.discard, aiChatItems.tryAgain] }],
  selectionCommand: [
    {
      items: [
        ...
        <CommandGroup key={index} heading={group.heading}>
          {group.items.map((menuItem) => (
            <CommandItem
              ...
              onSelect={() => menuItem.onSelect?.({ aiEditor, editor: editor })}
            >
              {menuItem.icon}
