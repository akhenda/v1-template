...
const discussionsData: TDiscussion[] = [
  {
    ...
    comments: [
      {
        id: 'comment1',
        contentRich: [{ children: [{ text: 'This is a comment' }], type: 'p' }],
    ...
    comments: [
      {
        id: 'comment1',
        contentRich: [
          { children: [{ text: 'Hey, what do you think about this approach?' }], type: 'p' },
        ],
        createdAt: new Date(Date.now() - 900_000),
        discussionId: 'discussion1',
        isEdited: false,
      ...
      {
        id: 'comment2',
        contentRich: [{ children: [{ text: 'Looks good!' }], type: 'p' }],
      ...
      {
        id: 'comment3',
        contentRich: [{ children: [{ text: 'Thanks for the feedback!' }], type: 'p' }],
    ...
    comments: [
      {
        id: 'comment1',
        contentRich: [
          { children: [{ text: 'This is a good example of how to use comments.' }], type: 'p' },
        ],
...
export const discussionPlugin = createPlatePlugin({
  key: 'discussion',
  options: { currentUserId: 'alice', discussions: discussionsData, users: usersData },
})
