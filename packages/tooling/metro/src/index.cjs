...
module.exports = {
   ...
   * @returns {MetroConfig}
   */
  withSentry: require('./with-sentry.cjs'),
   ...
   * @returns {import('expo/metro-config').MetroConfig}
   */
  withLottieAssets: require('./with-lottie-assets.cjs'),

  /**
   * Add reanimated support to Metro
   */
  withReanimated: require('./with-reanimated.cjs'),
