  ...
  return (
    ...
    >
      <g transform="matrix(2.07675 0 0 -2.07675 -11.153 92.77)">
        ...
        Use camelCase clipPath for React.
       */}
        <g clipPath="url(#b)">
          {/* V Shape (Dark Blue Part) */}
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#003087'}
          />
          {/* S Shape (Light Blue Part - Note: not yellow/gold) */}
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#009cde'}
          />
          {/* I Shape Base & A Shape Base (Dark Blue Parts) */}
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#003087'}
          />
          {/* A Shape Top & S Shape Detail (Light Blue Parts) */}
          <path
          ...
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#003087'}
          />
          {/* A Shape Top Detail (Light Blue Part) */}
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#009cde'}
          />
          {/* V Shape Detail/Overlap (Dark Blue Part) - Note: Paths below seem to refine the V shape */}
          <path
            d="M32.419 40.982c-1.674 1.908-4.7 2.726-8.571 2.726H12.613a1.609 1.609 0 0 1-1.59-1.357L6.347 12.68a.964.964 0 0 1 .953-1.114h6.936l1.742 11.049-.054-.346a1.604 1.604 0 0 0 1.583 1.357h3.296c6.475 0 11.545 2.63 13.026 10.238.044.225.082.444.115.658.44 2.812-.003 4.726-1.524 6.459"
            fill={overrideColor ? 'currentColor' : '#003087'}
          />
          ...
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#009cde'}
          />
          {/* V Shape Shading/Overlap (Darker Blue Part) */}
          <path
            ...
            fill={overrideColor ? 'currentColor' : '#012169'}
          />
        </g>
      </g>
    </svg>
