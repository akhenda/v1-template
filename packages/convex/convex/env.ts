...
export const env = createEnv({
  ...
  server: {
    ...
    // POLAR_PRODUCT_FREE: z.string().nonempty(),
    // POLAR_PRODUCT_LEGEND: z.string().nonempty(),
    // POLAR_PRODUCT_PRO_MONTHLY: z.string().nonempty(),
    // POLAR_PRODUCT_PRO_YEARLY: z.string().nonempty(),
    // POLAR_PRODUCT_PLUS_SMALL_PACK: z.string().nonempty(),
    // POLAR_PRODUCT_PLUS_MEDIUM_PACK: z.string().nonempty(),
    // POLAR_PRODUCT_PLUS_LARGE_PACK: z.string().nonempty(),
  },
  runtimeEnv: {
