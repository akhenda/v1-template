...
This file provides guidance to AI coding agents when working with the browser extension.

> **Note**: This file is the source of truth. `CLAUDE.md` is a symlink to this file.
> Always edit `AGENTS.md` directly, not the symlink.
